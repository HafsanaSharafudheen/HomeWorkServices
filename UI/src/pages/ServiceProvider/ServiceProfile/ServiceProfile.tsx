...
function ServiceProfile() {
  ...
  const fetchProfileDetails = async () => {
    try {
      ...
      if (response.status === 200) {
        ...
        if (response.data.profile.serviceCharges.length===0) {
  ...
  const saveServiceCharges = async () => {
    try {
      const response = await axios.post('/service-charges', serviceCharges);
      if (response.status === 200) {
                    ...
                    <div className="service-profile-header">
                      <div className="profile-info">
                        ...
                        <div className="profile-details">
                          ...
                          <div><strong>Phone:</strong> {profile.contactNumber}</div>
                          <div><strong>Category:</strong> {profile.serviceCategory}</div>
                          <div><strong>Experience:</strong> {profile.yearsOfExperience} years</div>
                        </div>
                      </div>
                      <div className="profile-image">
                        ...
                        <button
                          className={`btn-availability ${isAvailable ? 'available' : 'not-available'}`}
                ...
                <div className="row">
                  <div className="col-6">
                    <div className="profile-card">
                      <h6>Education</h6>
                      <p>{profile?.education.institute}, {profile?.education.year}</p>
                    </div>
                  </div>
                  <div className="col-6">
                    <div className="profile-card">
      ...
      >
        ...
        <div className="col-md-3 form-floating mb-3">
          <Form.Control
            ...
            className="DefaultInput no-focus"
            required
            placeholder="Onsite Visit Charge"
          />
        ...
        <div className="col-md-3 form-floating mb-3">
          <Form.Control
            ...
            className="DefaultInput no-focus"
            required
            placeholder="Advanced Service Charge"
          />
